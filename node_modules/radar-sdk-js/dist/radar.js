	...
	*/
	  ...
	  _createClass(Http, null, [{
	    ...
	    value: function request(method, path, data) {
	      return new Promise(function (resolve, reject) {
	        ...
	        var publishableKey = Cookie.getCookie(Cookie.PUBLISHABLE_KEY);
	        ...
	        return regeneratorRuntime.wrap(function _callee2$(_context2) {
	          while (1) {
	            switch (_context2.prev = _context2.next) {
	              ...
	              case 9:
	                latitude = geocodeOptions.latitude, longitude = geocodeOptions.longitude;
	                params = {
	                  coordinates: "".concat(latitude, ",").concat(longitude)
	                };
	        ...
	        return regeneratorRuntime.wrap(function _callee$(_context) {
	          while (1) {
	            switch (_context.prev = _context.next) {
	              ...
	              case 8:
	                origin = routingOptions.origin, destination = routingOptions.destination, modes = routingOptions.modes, units = routingOptions.units;
	        ...
	        return regeneratorRuntime.wrap(function _callee2$(_context2) {
	          while (1) {
	            switch (_context2.prev = _context2.next) {
	              ...
	              case 8:
	                near = searchOptions.near, radius = searchOptions.radius, tags = searchOptions.tags, limit = searchOptions.limit;
	                near = "".concat(near.latitude, ",").concat(near.longitude);
	        ...
	        return regeneratorRuntime.wrap(function _callee3$(_context3) {
	          while (1) {
	            switch (_context3.prev = _context3.next) {
	              ...
	              case 4:
	                _yield$Navigator$getC3 = _context3.sent;
	                latitude = _yield$Navigator$getC3.latitude;
	                longitude = _yield$Navigator$getC3.longitude;
	                searchOptions.near = {
	                  latitude: latitude,
	                  longitude: longitude
	                };
	              ...
	              case 8:
	                query = searchOptions.query, near = searchOptions.near, limit = searchOptions.limit;
	                near = "".concat(near.latitude, ",").concat(near.longitude);
	                params = {
	                  query: query,
	                  near: near,
	...
	var Device = /*#__PURE__*/function () {
	  ...
	  _createClass(Device, null, [{
	    ...
	    value: function getId() {
	      ...
	      var deviceId = Cookie.getCookie(Cookie.DEVICE_ID);
	          ...
	          while (1) {
	            switch (_context.prev = _context.next) {
	              ...
	              case 5:
	                ...
	                _context.next = 13;
	                return Http.request('PUT', "v1/users/".concat(_id), body);
	...
	var Radar = /*#__PURE__*/function () {
	  ...
	  _createClass(Radar, null, [{
	    ...
	    key: "trackOnce",
	    value: function trackOnce(arg0, arg1) {
	      var callback;
	      var location;
	    ...
	    key: "getContext",
	    value: function getContext(arg0, arg1) {
	      if (!arg0) {
	        throw new Error(STATUS.ERROR_MISSING_CALLBACK);
	      }
	    ...
	    key: "searchPlaces",
	    value: function searchPlaces(searchOptions, callback) {
	      if (!callback) {
	        throw new Error(STATUS.ERROR_MISSING_CALLBACK);
	      }
	    ...
	    key: "searchGeofences",
	    value: function searchGeofences(searchOptions, callback) {
	      if (!callback) {
	        throw new Error(STATUS.ERROR_MISSING_CALLBACK);
	      }
	    ...
	    key: "autocomplete",
	    value: function autocomplete(searchOptions, callback) {
	      if (!callback) {
	        throw new Error(STATUS.ERROR_MISSING_CALLBACK);
	      }
	    ...
	    key: "geocode",
	    value: function geocode(geocodeOptions, callback) {
	      if (!callback) {
	        throw new Error(STATUS.ERROR_MISSING_CALLBACK);
	      }
	    ...
	    key: "reverseGeocode",
	    value: function reverseGeocode(arg0, arg1) {
	      if (!arg0) {
	        throw new Error(STATUS.ERROR_PARAMETERS);
	      }
	    ...
	    key: "ipGeocode",
	    value: function ipGeocode(arg0, arg1) {
	      if (!arg0) {
	        throw new Error(STATUS.ERROR_PARAMETERS);
	      }
	      ...
	      Geocoding.ipGeocode(geocodeOptions).then(function (response) {
	        callback(null, {
	    ...
	    key: "getDistance",
	    value: function getDistance(routingOptions, callback) {
	      if (!callback) {
	        throw new Error(STATUS.ERROR_MISSING_CALLBACK);
	      }
